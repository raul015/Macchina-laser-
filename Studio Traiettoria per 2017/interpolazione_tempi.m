...
x= interp1(t_m,x_i,u,'Linear',0);
xp= interp1(t_m,xp_i,u,'Linear',0);
xpp= interp1(t_m,xpp_i,u,'Linear',0);
%interpolazione tempi asse y
y= interp1(t_m,y_i,u,'Linear',0);
yp= interp1(t_m,yp_i,u,'Linear',0);
ypp= interp1(t_m,ypp_i,u,'Linear',0);
