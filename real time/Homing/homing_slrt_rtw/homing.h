...
#ifndef RTW_HEADER_homing_h_
#define RTW_HEADER_homing_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_homing                 RT_MODEL_homing_T

/* Definition for use in the target main file */
#define homing_rtModel                 RT_MODEL_homing_T
...
typedef struct {
  ...
  real_T Uk1;                          /* '<S4>/UD' */
  real_T Diff;                         /* '<S4>/Diff' */
  real_T TSamp_e;                      /* '<S6>/TSamp' */
  real_T Uk1_e;                        /* '<S6>/UD' */
  real_T Diff_p;                       /* '<S6>/Diff' */
  ...
  real_T TSamp_m;                      /* '<S3>/TSamp' */
  real_T Uk1_j;                        /* '<S3>/UD' */
  real_T Diff_a;                       /* '<S3>/Diff' */
  real_T pozionemotorey;               /* '<Root>/PCI 6229 ENC 1' */
  real_T posizionemotorey;             /* '<Root>/Gain2' */
  real_T TSamp_d;                      /* '<S5>/TSamp' */
  real_T Uk1_jq;                       /* '<S5>/UD' */
  real_T Diff_i;                       /* '<S5>/Diff' */
...
typedef struct {
  ...
  uint8_T is_active_c3_homing;         /* '<Root>/Chart' */
  uint8_T is_c3_homing;                /* '<Root>/Chart' */
  uint8_T is_Homing;                   /* '<Root>/Chart' */
} DW_homing_T;

/* Backward compatible GRT Identifiers */
#define rtB                            homing_B
#define BlockIO                        B_homing_T
#define rtP                            homing_P
#define Parameters                     P_homing_T
#define rtDWork                        homing_DW
#define D_Work                         DW_homing_T
 ...
 * External functions *
 *====================*/
extern homing_rtModel *homing(void);
 ...
 * '<S1>'   : 'homing/Chart'
 * '<S2>'   : 'homing/Chart1'
 * '<S3>'   : 'homing/Discrete Derivative'
 * '<S4>'   : 'homing/Discrete Derivative1'
 * '<S5>'   : 'homing/Discrete Derivative2'
 * '<S6>'   : 'homing/Discrete Derivative3'
 */
#endif                                 /* RTW_HEADER_homing_h_ */
