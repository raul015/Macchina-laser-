...
MODEL           = homing_ldm
MODULES         = rt_matrx.c rt_printf.c homing_ldm_capi.c homing_ldm_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = homing_ldm.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Davide\Desktop\Homing
...
MODELLIB                  = homing_ldmlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = homing_ldm_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\homing_ldm_slrt_rtw
