...
MODEL           = homing
MODULES         = rt_matrx.c rt_printf.c homing_capi.c homing_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = homing.mk
...
MODELLIB                  = hominglib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = homing_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\homing_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Davide\Desktop\Homing
