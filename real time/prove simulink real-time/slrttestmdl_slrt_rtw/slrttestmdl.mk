...
MODEL           = slrttestmdl
MODULES         = rtGetInf.c rtGetNaN.c rt_nonfinite.c slrttestmdl_capi.c slrttestmdl_data.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = slrttestmdl.mk
...
MODELLIB                  = slrttestmdllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = slrttestmdl_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slrttestmdl_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\slrt\blocks
