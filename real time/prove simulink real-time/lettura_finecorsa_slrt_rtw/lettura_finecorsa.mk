...
MODEL           = lettura_finecorsa
MODULES         = rt_matrx.c rt_printf.c lettura_finecorsa_capi.c lettura_finecorsa_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = lettura_finecorsa.mk
MATLAB_ROOT     = C:\Program Files\MATLAB 2017
ALT_MATLAB_ROOT = C:\PROGRA~1\MATLAB~1
MATLAB_BIN      = C:\Program Files\MATLAB 2017\bin
ALT_MATLAB_BIN  = C:\PROGRA~1\MATLAB~1\bin
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Davide\Desktop\PROVES~1
S_FUNCTIONS     = danipcim.c dinipcim.c donipcim.c encnipcim.c xpcionim.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\Davide\AppData\Roaming\MathWorks\MATLAB\R2017a\mex_C_win64.xml"
...
MODELLIB                  = lettura_finecorsalib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = lettura_finecorsa_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\lettura_finecorsa_slrt_rtw
