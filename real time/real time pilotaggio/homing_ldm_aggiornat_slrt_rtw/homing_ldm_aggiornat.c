...
#define homing_ldm_aggior_IN_Pilotaggio ((uint8_T)2U)
...
static real_T homing_ldm_aggiornat_interp1(const real_T varargin_1[3320], const
  real_T varargin_2[3320], real_T varargin_3, real_T varargin_5);
static real_T homing_ldm_aggiornat_interp1_b(const real_T varargin_1[3320],
  const real_T varargin_2[3320], real_T varargin_3);
static void homing_ld_interpolazione_tempi2(const real_T x_i[3320], const real_T
  xp_i[3320], const real_T y_i[3320], const real_T yp_i[3320], real_T u, const
  real_T t_m[3320], real_T riff_iniziale, real_T *xx, real_T *xxp, real_T *yy,
  real_T *yyp);
  ...
  real_T varargin_2[3320], real_T varargin_3, real_T varargin_5)
{
  ...
  int32_T mid_i;
  int32_T exitg1;
  memcpy(&homing_ldm_aggiornat_B.b_y[0], &varargin_2[0], 3320U * sizeof(real_T));
  memcpy(&homing_ldm_aggiornat_B.b_x[0], &varargin_1[0], 3320U * sizeof(real_T));
  Vq = varargin_5;
  low_i = 1;
  do {
    exitg1 = 0;
    if (low_i < 3321) {
      ...
      if (varargin_1[1] < varargin_1[0]) {
        for (low_i = 0; low_i < 1660; low_i++) {
          r = homing_ldm_aggiornat_B.b_x[low_i];
          homing_ldm_aggiornat_B.b_x[low_i] = homing_ldm_aggiornat_B.b_x[3319 -
            low_i];
          homing_ldm_aggiornat_B.b_x[3319 - low_i] = r;
        }

        for (low_i = 0; low_i < 1660; low_i++) {
          r = homing_ldm_aggiornat_B.b_y[low_i];
          homing_ldm_aggiornat_B.b_y[low_i] = homing_ldm_aggiornat_B.b_y[3319 -
            low_i];
          homing_ldm_aggiornat_B.b_y[3319 - low_i] = r;
        }
      }
      ...
      if (rtIsNaN(varargin_3)) {
        ...
        if ((!(varargin_3 > homing_ldm_aggiornat_B.b_x[3319])) && (!(varargin_3 <
              homing_ldm_aggiornat_B.b_x[0]))) {
          low_i = 1;
          low_ip1 = 2;
          high_i = 3320;
          while (high_i > low_ip1) {
            mid_i = (low_i + high_i) >> 1;
            if (varargin_3 >= homing_ldm_aggiornat_B.b_x[mid_i - 1]) {
              low_i = mid_i;
              low_ip1 = mid_i + 1;
            } else {
              high_i = mid_i;
          ...
          r = (varargin_3 - homing_ldm_aggiornat_B.b_x[low_i - 1]) /
            (homing_ldm_aggiornat_B.b_x[low_i] -
             homing_ldm_aggiornat_B.b_x[low_i - 1]);
          if (r == 0.0) {
            Vq = homing_ldm_aggiornat_B.b_y[low_i - 1];
          } else if (r == 1.0) {
            Vq = homing_ldm_aggiornat_B.b_y[low_i];
          } else if (homing_ldm_aggiornat_B.b_y[low_i - 1] ==
                     homing_ldm_aggiornat_B.b_y[low_i]) {
            Vq = homing_ldm_aggiornat_B.b_y[low_i - 1];
          } else {
            Vq = (1.0 - r) * homing_ldm_aggiornat_B.b_y[low_i - 1] + r *
              homing_ldm_aggiornat_B.b_y[low_i];
          }
        }
      }
  ...
  const real_T varargin_2[3320], real_T varargin_3)
{
  ...
  int32_T mid_i;
  int32_T exitg1;
  memcpy(&homing_ldm_aggiornat_B.b_y_m[0], &varargin_2[0], 3320U * sizeof(real_T));
  memcpy(&homing_ldm_aggiornat_B.b_x_c[0], &varargin_1[0], 3320U * sizeof(real_T));
  Vq = 0.0;
  low_i = 1;
  do {
    exitg1 = 0;
    if (low_i < 3321) {
      ...
      if (varargin_1[1] < varargin_1[0]) {
        for (low_i = 0; low_i < 1660; low_i++) {
          r = homing_ldm_aggiornat_B.b_x_c[low_i];
          homing_ldm_aggiornat_B.b_x_c[low_i] = homing_ldm_aggiornat_B.b_x_c
            [3319 - low_i];
          homing_ldm_aggiornat_B.b_x_c[3319 - low_i] = r;
        }

        for (low_i = 0; low_i < 1660; low_i++) {
          r = homing_ldm_aggiornat_B.b_y_m[low_i];
          homing_ldm_aggiornat_B.b_y_m[low_i] = homing_ldm_aggiornat_B.b_y_m
            [3319 - low_i];
          homing_ldm_aggiornat_B.b_y_m[3319 - low_i] = r;
        }
      }
      ...
      if (rtIsNaN(varargin_3)) {
        ...
        if ((!(varargin_3 > homing_ldm_aggiornat_B.b_x_c[3319])) &&
            (!(varargin_3 < homing_ldm_aggiornat_B.b_x_c[0]))) {
          low_i = 1;
          low_ip1 = 2;
          high_i = 3320;
          while (high_i > low_ip1) {
            mid_i = (low_i + high_i) >> 1;
            if (varargin_3 >= homing_ldm_aggiornat_B.b_x_c[mid_i - 1]) {
              low_i = mid_i;
              low_ip1 = mid_i + 1;
            } else {
              high_i = mid_i;
          ...
          r = (varargin_3 - homing_ldm_aggiornat_B.b_x_c[low_i - 1]) /
            (homing_ldm_aggiornat_B.b_x_c[low_i] -
             homing_ldm_aggiornat_B.b_x_c[low_i - 1]);
          if (r == 0.0) {
            Vq = homing_ldm_aggiornat_B.b_y_m[low_i - 1];
          } else if (r == 1.0) {
            Vq = homing_ldm_aggiornat_B.b_y_m[low_i];
          } else if (homing_ldm_aggiornat_B.b_y_m[low_i - 1] ==
                     homing_ldm_aggiornat_B.b_y_m[low_i]) {
            Vq = homing_ldm_aggiornat_B.b_y_m[low_i - 1];
          } else {
            Vq = (1.0 - r) * homing_ldm_aggiornat_B.b_y_m[low_i - 1] + r *
              homing_ldm_aggiornat_B.b_y_m[low_i];
          }
        }
      }
...
static void homing_ld_interpolazione_tempi2(const real_T x_i[3320], const real_T
  ...
  real_T *yyp)
{
  /* MATLAB Function 'interpolazione_tempi2': '<S1>:215' */
  /* interpolazione tempi asse x */
  /* '<S1>:215:3' */
  *xx = homing_ldm_aggiornat_interp1(t_m, x_i, u, riff_iniziale);

  /* '<S1>:215:4' */
  *xxp = homing_ldm_aggiornat_interp1_b(t_m, xp_i, u);

  /* interpolazione tempi asse y */
  /* '<S1>:215:7' */
  *yy = homing_ldm_aggiornat_interp1(t_m, y_i, u, riff_iniziale);

  /* '<S1>:215:8' */
  *yyp = homing_ldm_aggiornat_interp1_b(t_m, yp_i, u);
}
...
static void homing_ldm_aggiornat_output(void)
{
  ...
  homing_ldm_aggiornat_B.Constant11 = homing_ldm_aggiornat_P.ppx_c.g2;

  /* Constant: '<Root>/Constant12' */
  homing_ldm_aggiornat_B.Constant12 = homing_ldm_aggiornat_P.ppx_c.g1;

  /* Constant: '<Root>/Constant13' */
  homing_ldm_aggiornat_B.Constant13 = homing_ldm_aggiornat_P.ppy_c.g2;

  /* Constant: '<Root>/Constant14' */
  homing_ldm_aggiornat_B.Constant14 = homing_ldm_aggiornat_P.ppy_c.g1;

  /* Constant: '<Root>/Constant15' */
  B = homing_ldm_aggiornat_P.parx.tau;
  homing_ldm_aggiornat_B.Constant15 = 1.0 / B;

  /* Constant: '<Root>/Constant16' */
  B = homing_ldm_aggiornat_P.pary.tau;
  homing_ldm_aggiornat_B.Constant16 = 1.0 / B;
  ...
  if (homing_ldm_aggiornat_DW.is_active_c3_homing_ldm_aggiorn == 0U) {
    ...
    if (homing_ldm_aggiornat_DW.inizio_traiettoria == 1.0) {
      ...
      homing_ldm_aggiornat_DW.is_c3_homing_ldm_aggiornat =
        homing_ldm_aggior_IN_Pilotaggio;

      /* Entry Internal 'Pilotaggio': '<S1>:44' */
      /* Transition: '<S1>:58' */
      homing_ldm_aggiornat_DW.is_Pilotaggio = homing_ldm_aggior_IN_Pilotaggio;

      /* Entry 'Pilotaggio': '<S1>:59' */
      homing_ldm_aggiornat_DW.t1 = homing_ldm_aggiornat_B.Clock;
      homing_ldm_aggiornat_B.ok_y_3 = 1.0;
      homing_ldm_aggiornat_B.ok_x_3 = 1.0;
      homing_ldm_aggiornat_DW.deltax = 0.0;
      homing_ldm_aggiornat_DW.deltay = 0.0;
      homing_ldm_aggiornat_DW.deltaxp = 0.0;
      homing_ldm_aggiornat_DW.deltayp = 0.0;
      homing_ldm_aggiornat_DW.appoggio = 1.0;
      homing_ldm_aggiornat_DW.rif_iniziale = 0.0;
    } else {
      switch (homing_ldm_aggiornat_DW.is_Homing1) {
       ...
       case homing_ldm_aggi_IN_Fine_homing1:
        ...
        sf_internal_predicateOutput = ((homing_ldm_aggiornat_DW.dx > 0.6) &&
          (homing_ldm_aggiornat_DW.dy > 0.4));
        if (sf_internal_predicateOutput) {
          ...
          if (homing_ldm_aggiornat_DW.dx > 0.6) {
          ...
          if (homing_ldm_aggiornat_DW.dy > 0.4) {
    ...
    /* During 'Pilotaggio': '<S1>:44' */
    if (homing_ldm_aggiornat_DW.is_Pilotaggio == homing_ldm_aggiornat_IN_Fine) {
      homing_ldm_aggiornat_B.ok_x_2 = 0.0;
      homing_ldm_aggiornat_B.ok_y_2 = 0.0;
      homing_ldm_aggiornat_B.ok_x = 0.0;
      homing_ldm_aggiornat_B.ok_y = 0.0;
      homing_ldm_aggiornat_B.ok_y_3 = 0.0;
      homing_ldm_aggiornat_B.ok_x_3 = 0.0;
      ...
      /* During 'Pilotaggio': '<S1>:59' */
      if ((fabs(homing_ldm_aggiornat_B.tensionex) == 10.0) || (fabs
           (homing_ldm_aggiornat_B.tensioney) == 10.0)) {
      ...
      if (sf_internal_predicateOutput) {
        /* Transition: '<S1>:93' */
        homing_ldm_aggiornat_DW.is_Pilotaggio = homing_ldm_aggiornat_IN_Fine;
        ...
        homing_ldm_aggiornat_DW.t = homing_ldm_aggiornat_B.Clock -
          homing_ldm_aggiornat_DW.t1;
        if (homing_ldm_aggiornat_B.Clock - homing_ldm_aggiornat_DW.t1 == 0.0) {
          homing_ldm_aggiornat_DW.rif_iniziale = homing_ldm_aggiornat_DW.t;
        }

        homing_ld_interpolazione_tempi2(homing_ldm_aggiornat_P.x,
          homing_ldm_aggiornat_P.Vel_asse_x, homing_ldm_aggiornat_P.y,
          homing_ldm_aggiornat_P.Vel_asse_y, homing_ldm_aggiornat_DW.t,
          homing_ldm_aggiornat_P.time, homing_ldm_aggiornat_DW.rif_iniziale, &A,
          &B, &rify, &rifyp);
        homing_ldm_aggiornat_DW.rifx = A;
        homing_ldm_aggiornat_DW.rifxp = B;
        homing_ldm_aggiornat_DW.rify = rify;
        homing_ldm_aggiornat_DW.rifyp = rifyp;

        /* [rifx,rifxp,rify,rifyp]= interpolazione_tempi2(x_i,xp_i,y_i,yp_i,u,t_m) */
        homing_ldm_aggiornat_DW.deltax =
          homing_ldm_aggiornat_B.posizionecarrellox_n -
          homing_ldm_aggiornat_DW.rifx;
        homing_ldm_aggiornat_DW.deltay =
          homing_ldm_aggiornat_B.posizionecarrelloy_e -
          homing_ldm_aggiornat_DW.rify;
        homing_ldm_aggiornat_DW.deltaxp = homing_ldm_aggiornat_B.Diff_k -
          homing_ldm_aggiornat_DW.rifxp;
        homing_ldm_aggiornat_DW.deltayp = homing_ldm_aggiornat_B.Diff -
          homing_ldm_aggiornat_DW.rifyp;

        /* controllore posizionamento poli */
        homing_ldm_aggiornat_B.tensionex = (-homing_ldm_aggiornat_DW.deltaxp *
          homing_ldm_aggiornat_B.Constant11 - homing_ldm_aggiornat_DW.deltax *
          homing_ldm_aggiornat_B.Constant12) * homing_ldm_aggiornat_B.Constant15
          / 30.0;

        /* 25 */
        homing_ldm_aggiornat_B.tensioney = (-homing_ldm_aggiornat_DW.deltayp *
          homing_ldm_aggiornat_B.Constant13 - homing_ldm_aggiornat_DW.deltay *
          homing_ldm_aggiornat_B.Constant14) * homing_ldm_aggiornat_B.Constant16
          / 50.0;

        /* 30 */
        if (homing_ldm_aggiornat_B.tensioney > 1.4) {
          homing_ldm_aggiornat_B.tensioney = 1.4;
        }
        ...
        if (homing_ldm_aggiornat_B.tensionex > 2.2) {
          homing_ldm_aggiornat_B.tensionex = 2.2;
        }
  ...
  A = homing_ldm_aggiornat_B.Gain1;
  B = homing_ldm_aggiornat_B.ok_x;
  homing_ldm_aggiornat_B.DotProduct1 = A * B;

  /* DotProduct: '<Root>/Dot Product3' */
  A = homing_ldm_aggiornat_B.tensioney;
  B = homing_ldm_aggiornat_B.ok_y_3;
  homing_ldm_aggiornat_B.DotProduct3 = A * B;

  /* DotProduct: '<Root>/Dot Product4' */
  A = homing_ldm_aggiornat_B.tensionex;
  B = homing_ldm_aggiornat_B.ok_x_3;
  homing_ldm_aggiornat_B.DotProduct4 = A * B;
  ...
  A = homing_ldm_aggiornat_B.Gain3;
  B = homing_ldm_aggiornat_B.ok_x_2;
  homing_ldm_aggiornat_B.DotProduct7 = A * B;

  /* Sum: '<Root>/Sum1' */
  homing_ldm_aggiornat_B.sommax = (homing_ldm_aggiornat_B.DotProduct1 +
    homing_ldm_aggiornat_B.DotProduct7) + homing_ldm_aggiornat_B.DotProduct4;

  /* DotProduct: '<Root>/Dot Product2' */
  A = homing_ldm_aggiornat_B.Gain2;
  B = homing_ldm_aggiornat_B.ok_y;
  homing_ldm_aggiornat_B.DotProduct2 = A * B;
  ...
  A = homing_ldm_aggiornat_B.Gain5;
  B = homing_ldm_aggiornat_B.ok_y_2;
  homing_ldm_aggiornat_B.DotProduct8 = A * B;

  /* Sum: '<Root>/Sum6' */
  homing_ldm_aggiornat_B.sommay = (homing_ldm_aggiornat_B.DotProduct2 +
    homing_ldm_aggiornat_B.DotProduct8) + homing_ldm_aggiornat_B.DotProduct3;
...
static void homing_ldm_aggiornat_initialize(void)
{
  ...
  homing_ldm_aggiornat_DW.sfEvent = homing_ldm_aggiornat_CALL_EVENT;
  homing_ldm_aggiornat_DW.is_Homing1 = homing_ldm_a_IN_NO_ACTIVE_CHILD;
  homing_ldm_aggiornat_DW.is_Pilotaggio = homing_ldm_a_IN_NO_ACTIVE_CHILD;
...
RT_MODEL_homing_ldm_aggiornat_T *homing_ldm_aggiornat(void)
{
    ...
    /* Level2 S-Function Block: homing_ldm_aggiornat/<Root>/PCI-6229 DA1 (danipcim) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &homing_ldm_aggiornat_B.sommax;
    ...
    /* Level2 S-Function Block: homing_ldm_aggiornat/<Root>/PCI-6229 DA2 (danipcim) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &homing_ldm_aggiornat_B.sommay;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidth(rts, 0, 1);
        }
  ...
  homing_ldm_aggiornat_M->Sizes.numBlocks = (94);/* Number of blocks */
  homing_ldm_aggiornat_M->Sizes.numBlockIO = (57);/* Number of block outputs */
  homing_ldm_aggiornat_M->Sizes.numBlockPrms = (16830);/* Sum of parameter "widths" */
