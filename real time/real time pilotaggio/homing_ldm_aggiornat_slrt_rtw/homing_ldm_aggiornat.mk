...
MODEL           = homing_ldm_aggiornat
MODULES         = rt_matrx.c rt_printf.c homing_ldm_aggiornat_capi.c homing_ldm_aggiornat_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = homing_ldm_aggiornat.mk
MATLAB_ROOT     = D:\Matlab 2017
ALT_MATLAB_ROOT = D:\MATLAB~1
MATLAB_BIN      = D:\Matlab 2017\bin
ALT_MATLAB_BIN  = D:\MATLAB~1\bin
MASTER_ANCHOR_DIR = 
START_DIR       = D:\Stefano\AAINGE~1\ANNO5~1\SEMEST~2\LABORA~1\SM2TUT~1\REALTI~2\REALTI~1
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\stefa\AppData\Roaming\MathWorks\MATLAB\R2017a\mex_C_win64.xml"
...
MODELLIB                  = homing_ldm_aggiornatlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = homing_ldm_aggiornat_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\homing_ldm_aggiornat_slrt_rtw
